import { EmptyObject, EventEntityBase } from './core';
import { ClientMessageBase } from './message';
export type DTMFParameters = { digit: string; };
...
export type EventEntityDataBotTurnResponse = { disposition: BotTurnDisposition; text?: string; confidence?: number; };
